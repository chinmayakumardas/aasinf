      ...
      <div className="bg-gray-50 py-16 px-8 min-h-screen">
        <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-xl">
          ...
          <p className="text-xl text-gray-600 leading-relaxed mb-6">
            At [Your Company Name], we are committed to protecting your privacy. This Privacy Policy outlines how we collect, use, and safeguard your information when you use our services.
          </p>
